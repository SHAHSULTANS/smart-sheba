...
// Update imports to use the enhanced pages
import '../../presentation/auth/bloc/auth_bloc.dart';
import '../../presentation/auth/pages/enhanced_login_page.dart';
import '../../presentation/auth/pages/enhanced_otp_verification_page.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          // Use the new enhanced class
          return EnhancedOtpVerificationPage(phoneNumber: phoneNumber ?? '');
        },
      ),
